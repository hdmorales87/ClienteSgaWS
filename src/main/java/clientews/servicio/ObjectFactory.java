...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://service.ee.java.com/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://service.ee.java.com/", "listarPersonasResponse");
    private final static QName _Persona_QNAME = new QName("http://service.ee.java.com/", "persona");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ee.java.com/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ee.java.com/", name = "listarPersonasResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ee.java.com/", name = "persona")
