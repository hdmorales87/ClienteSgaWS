 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://service.ee.java.com/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://service.ee.java.com/", "PersonaServiceImplService");
    ...
    public PersonaServiceWS getPersonaServiceImplPort() {
        return super.getPort(new QName("http://service.ee.java.com/", "PersonaServiceImplPort"), PersonaServiceWS.class);
    }
    ...
    public PersonaServiceWS getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ee.java.com/", "PersonaServiceImplPort"), PersonaServiceWS.class, features);
    }
